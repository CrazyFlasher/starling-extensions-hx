...
class Main extends openfl.display.Sprite
{
    ...
    private function loadAssets(onComplete:Void -> Void):Void
    {
        ...
        _assets.enqueue([
            Assets.getPath("assets/bg.png"),
            Assets.getPath("assets/particle.png"),
            Assets.getPath("assets/pixelmask.png"),
            Assets.getPath("assets/atlas.xml")
        ]);
        _assets.enqueueSingle("assets/particle.pex", "particle_pex");
